...
struct SymbolTableReadOptions {
  OPENFSTDLL SymbolTableReadOptions() { } //ChangedPD

  OPENFSTDLL SymbolTableReadOptions(vector<pair<int64, int64> > string_hash_ranges_, //ChangedPD
...
struct SymbolTableTextOptions {
  OPENFSTDLL SymbolTableTextOptions(); //ChangedPD
...
class SymbolTableImpl {
 public:
  ...
  static OPENFSTDLL SymbolTableImpl* ReadText( //ChangedPD
 ...
 private:
  ...
  void OPENFSTDLL MaybeRecomputeCheckSum() const; //ChangedPD
...
class SymbolTable {
 public:
  ...
  virtual OPENFSTDLL bool WriteText( //ChangedPD
      ostream &strm,
